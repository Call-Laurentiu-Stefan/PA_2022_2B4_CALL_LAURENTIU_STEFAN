...
public class ControlPanel extends JPanel {
    ...
    private void load(ActionEvent actionEvent) {
            try{
                ...
                frame.canvas.image = ImageIO.read(new File("D:\\PA_2022_2B4_CALL_LAURENTIU_STEFAN\\Lab6\\test\\" + i + ".png"));
    ...
    private void save(ActionEvent actionEvent) {
        try {
            ImageIO.write(frame.canvas.image, "PNG", new File("D:\\PA_2022_2B4_CALL_LAURENTIU_STEFAN\\Lab6\\test" + i + ".png"));
            i++;
